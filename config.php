...
# $conf->app_root = '/kalkulator_kredytowy/public';   # project subfolder in domain (relative to main domain)
$conf->app_root = '/todolist/public';   # project subfolder in domain (relative to main domain)
