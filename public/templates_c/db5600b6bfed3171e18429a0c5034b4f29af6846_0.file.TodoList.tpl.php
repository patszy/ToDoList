...
function content_628cfaa8717575_85380379 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_794410468628cfaa86fad42_63510322', 'top');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "main.tpl");
}
/* {block 'top'} */
class Block_794410468628cfaa86fad42_63510322 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'top' => 
  array (
    0 => 'Block_794410468628cfaa86fad42_63510322',
  ),
);
...
?>
        ...
        <section class="todo-list-container">
            <header class="todo-list-header">
				...
				<?php if (!empty($_smarty_tpl->tpl_vars['conf']->value->roles['user'])) {?>
...
?>
				<div class="todo-item"><div class="todo-item-bar"><?php if (!empty($_smarty_tpl->tpl_vars['conf']->value->roles['user'])) {?><a class="todo-item-show" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
...
</h3><?php if (!empty($_smarty_tpl->tpl_vars['conf']->value->roles['user'])) {?><a class="todo-item-delete" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
todoDelete/<?php echo $_smarty_tpl->tpl_vars['l']->value['id_list'];?>
" title="Delete"><i class="fas fa-times-circle"></i></a><?php }?></div><div class="todo-item-header"><h3 class="todo-item-title"><?php echo $_smarty_tpl->tpl_vars['l']->value["title"];?>
</h3><?php if (!empty($_smarty_tpl->tpl_vars['conf']->value->roles['user'])) {?><a class="todo-item-edit" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_url;?>
